...
module StrictInitialize
  ALLOWED_TYPES = [String, Numeric, TrueClass, FalseClass, Array, Struct].freeze
...
SymlinkLocationOptions = Struct.new(
  :movies,
  :incomplete_series,
  :complete_series,
  :incomplete_other,
...
PlexScanLibraryOption = Struct.new(
